    ...
    return (
        <div>
            ...
            <div className="relative bg-gray-400 w-full overflow-hidden flex flex-col items-center justify-start pt-[4rem] px-[0rem] pb-[8rem] box-border gap-[4rem] text-center text-[1.25rem] text-white font-staatliches">
                ...
                <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-start justify-start gap-6 sm:gap-8 lg:gap-12 text-left text-lg sm:text-xl md:text-2xl lg:text-3xl font-dm-sans">
                    <div className="self-stretch flex flex-row items-start justify-start gap-[4rem] text-center text-[1rem] text-darkgray">
                        <div className="flex flex-col items-start justify-start gap-[1.25rem]">
                            <img className="w-full max-w-[25.875rem] 
    h-auto 
    relative rounded-xl 
    object-cover" alt="" src={main} />
                        ...
                        <div className="w-full max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-start justify-start gap-8 sm:gap-10 lg:gap-12 text-left text-base sm:text-lg md:text-xl lg:text-2xl text-white">
                            ...
                            <div className="self-stretch flex flex-row items-start justify-start gap-[1.25rem] text-[0.875rem]">
                                <div className="w-full max-w-[25.188rem] aspect-[25.188/14] rounded flex flex-col items-start justify-end p-3 box-border bg-[url('./assets/HeadingContent.png')] bg-cover bg-no-repeat bg-top">
                                ...
                                <div className="flex-1 [backdrop-filter:blur(48px)] rounded bg-gray-300 border-gray-200 border-solid border-[1px] flex flex-col items-start justify-start pt-[0.5rem] px-[0.75rem] pb-[0.75rem] gap-[0.75rem] text-[1rem] text-gray-100">
                                    ...
                                    <div className="self-stretch flex flex-col items-center justify-center gap-[0.5rem] text-[0.875rem]">
                                        <div className="self-stretch rounded-lg bg-gray-300 flex flex-row items-center justify-start py-[0rem] pl-[0rem] pr-[0.75rem] relative gap-[0.75rem]">
                                            <img className="w-full max-w-[9.75rem] 
  aspect-[9.75/5] 
  relative 
  rounded-tl rounded-tr-none rounded-br-none rounded-bl 
  object-cover 
  z-0" alt="" src={Screenshot} />
                                            <div className="flex-1 flex flex-col items-start justify-start gap-3 sm:gap-4 md:gap-6 z-1">
                                                <div className="self-stretch text-[#fff] relative leading-[1.25rem] font-medium">
                                                    Mission: Impossible – Dead Reckoning..
                                                </div>
                                                <div className="relative text-[0.75rem] leading-[1rem] text-darkgray text-right">
                                                    2:10
                                                </div>
                                            </div>

                                            <img className="absolute w-[2rem] sm:w-[1.5rem] h-[2rem] sm:h-[1.5rem] top-[1.563rem] sm:top-[1rem] left-[4rem] sm:left-[2rem] z-2" alt="" src={PlayButton} />
                                        </div>
                                        <div className="self-stretch rounded-lg bg-gray-300 flex flex-row items-center justify-start py-[0rem] pl-[0rem] pr-[0.75rem] relative gap-[0.75rem]">
                                            <img className="w-full max-w-[9.75rem] aspect-[9.75/5] relative rounded-tl rounded-tr-none rounded-br-none rounded-bl object-cover z-0" alt="" src={Screenshot2} />
                                            <div className="flex-1 flex flex-col items-start justify-start gap-[0.75rem] z-1">
                                                <div className="self-stretch text-[#fff] relative leading-[1.25rem] font-medium">
                                                    When You’re More Than Just Weird
                                                </div>
                                                <div className="relative text-[0.75rem] leading-[1rem] text-darkgray text-right">
                                                    2:01
                                                </div>
                                            ...
                                            <img className="absolute w-[2rem] sm:w-[1.5rem] h-[2rem] sm:h-[1.5rem] top-[1.625rem] left-[4rem] sm:left-[2rem] z-2" alt="" src={PlayButton} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-start justify-start gap-4 sm:gap-6 lg:gap-8">
                        <div className="self-stretch flex flex-row items-center justify-between gap-[0rem]">
                    ...
                    <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-row items-start justify-start gap-4 sm:gap-6 lg:gap-10 text-base sm:text-lg md:text-xl lg:text-2xl font-staatliches">
